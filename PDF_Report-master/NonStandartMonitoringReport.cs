...
namespace PDF_Report
{
    public class NonStandartMonitoringReport : MonitoringReport
    {
        ...
        public NonStandartMonitoringReport()
        {
            ParamsReplace = new Dictionary<string, string>()
            {
                {"[ABB]", "0" },
                {"[YEAR]", "0" },
                {"[ION_NAME]", "0" },
